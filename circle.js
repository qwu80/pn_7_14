class Vehicle{
    ...
    display(){
        ...
        if (this.color == 0){
            ...
            if (this.position.x<470*s_x) {
               

 
                fill(254,246,182, 100);
            stroke(254,246,182, 100);
            ellipse(this.position.x,(-array_band2[99]+array_band_hardcode[99]+array_band_hardcode[99]+70-array_band_hardcode[99]-this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3)*s_y,5)
            } else {
                fill(254,246,182, 100);
            stroke(254,246,182, 100);
            ellipse(this.position.x,(-array_band2[99]+array_band_hardcode[99]+70-array_band_hardcode[99]-this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3)*s_y,5)
            }
            ...
            // ellipse(630*s_x,200*s_y,20)
             ...
             if (this.position.x>630*s_x){
                noFill();
                stroke(125, 241, 148,  100); //green
                strokeWeight(1);
                ellipse(this.position.x,144*s_y-array_band_hardcode[99]+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
             }else {
                noFill();
                stroke(125, 241, 148,  100); //green
                strokeWeight(1);
                ellipse(this.position.x,144*s_y+this.botz*(-array_band_hardcode[99]-array_band_hardcode[0])*0.3,5)
            }
